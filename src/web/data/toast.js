...
(function() {
  ...
  /**
   * Show a confirmation dialog as an inline toast with action buttons.
   * @param {string} message - The question to ask the user
   * @param {Function} onConfirm - Called when the user confirms
   * @param {Function} [onCancel] - Called when the user cancels (optional)
   * @param {string} [cancelLabel] - Label for the cancel button (default: "Cancel")
   * @param {string} [confirmLabel] - Label for the confirm button (default: "OK")
   * @returns {number} Toast ID
   */
  function showConfirm(message, onConfirm, onCancel, cancelLabel, confirmLabel) {
    ...
    confirmBtn.className = 'toast-action-btn toast-action-confirm';
    ...
    cancelBtn.className = 'toast-action-btn toast-action-cancel';
    ...
    const toastObj = { id: id, element: toast, duration: 0, timeoutId: null, paused: false, remaining: 0 };
